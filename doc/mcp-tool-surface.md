...
**Pause / Resume**: microsandbox v0.6.17 has no pause or resume API. The adapter returns `ErrUnsupported` for both. Advertising a tool that always fails is worse than omitting it.
